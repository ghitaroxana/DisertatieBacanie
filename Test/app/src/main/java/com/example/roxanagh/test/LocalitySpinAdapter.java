 ...
 */
public class LocalitySpinAdapter extends ArrayAdapter<Locality> {

    // Your sent context
    private Context context;
    // Your custom values for the spinner (User)
    private Locality[] values;

    public LocalitySpinAdapter(Context context, int textViewResourceId,
                             Locality[] values) {
